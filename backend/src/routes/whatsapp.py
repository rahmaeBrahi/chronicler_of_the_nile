...
def verify_webhook():
    ...
    # In a production environment, this MUST be enabled and properly configured.
    if mode == 'subscribe':
        print("✅ Webhook verification bypassed for local testing.")
        return challenge
    else:
        print("❌ Webhook verification failed (bypassed mode). Please ensure you are in 'subscribe' mode for testing.")
